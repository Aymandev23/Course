...
export function CourseCard({ title, description, image, progress, category, mentor }: CourseCardProps) {
  return (
      ...
      <Card>
        ...
        <CardContent>
          <div className="flex items-center gap-2">
            <div className="rounded bg-primary/10 px-2 py-1 text-xs font-medium text-primary">{category}</div>
            <div className="text-xs text-muted-foreground">{progress}% watched</div>
          </div>
