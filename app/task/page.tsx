...
import { Search, Filter, Plus, Calendar, Clock, CheckCircle2, XCircle, MoreHorizontal, Menu, Trash2, Edit } from 'lucide-react'
          ...
          >
            ...
            <Tabs defaultValue="all" className="space-y-4">
              <TabsList className="flex flex-wrap">
                <TabsTrigger value="all" onClick={() => setSelectedTab("all")}>All Tasks</TabsTrigger>
                <TabsTrigger value="in progress" onClick={() => setSelectedTab("in progress")}>In Progress</TabsTrigger>
                <TabsTrigger value="completed" onClick={() => setSelectedTab("completed")}>Completed</TabsTrigger>
                <TabsTrigger value="not started" onClick={() => setSelectedTab("not started")}>Not Started</TabsTrigger>
              </TabsList>
      ...
      <Card>
        <CardHeader className="flex flex-col sm:flex-row items-start sm:items-center justify-between space-y-2 sm:space-y-0 pb-2">
          <div className="flex items-center space-x-2">
            ...
            />
            <CardTitle className={`text-base sm:text-lg font-semibold ${task.status === "Completed" ? "line-through text-gray-500" : ""}`}>
              {task.title}
            </CardTitle>
          </div>
